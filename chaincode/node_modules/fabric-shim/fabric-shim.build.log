...
> fabric-shim@2.2.3 test /home/vsts/work/1/s/libraries/fabric-shim
> nyc mocha --recursive 'test/unit/**/*.js' --reporter spec-junit-splitter-mocha-reporter


> fabric-shim@2.2.3 lint /home/vsts/work/1/s/libraries/fabric-shim
> eslint ./lib
...
2022-05-03T10:10:23.143Z info [c-api:lib/chaincode.js]                            Registering with peer localhost:7051 as chaincode "mycc"  
      ✓ should start when passed init and invoke
2022-05-03T10:10:23.149Z info [c-api:lib/chaincode.js]                            Registering with peer localhost:7051 as chaincode "mycc"  
...
2022-05-03T10:10:23.179Z info [c-api:lib/chaincode.js]                            Registering with peer localhost:7051 as chaincode "mycc"  
        ✓ should call handler.chat() with the correct object and output a message
2022-05-03T10:10:23.186Z info [c-api:lib/chaincode.js]                            Registering with peer localhost:7051 as chaincode "mycc"  
        ✓ should load the opts certificate attributes as JSON strings with the correct properties
    parsePeerUrlFcn
2022-05-03T10:10:23.191Z error [c-api:lib/chaincode.js]                           The "peer.address" program argument must be set to a legitimate value of <host>:<port>  
      ✓ should throw an error if peer.address not set
2022-05-03T10:10:23.195Z error [c-api:lib/chaincode.js]                           The "peer.address" program argument can not be set to an "http(s)" url, use grpc(s) or omit the protocol  
...
2022-05-03T10:10:23.386Z info [c-api:fabric-shim/cli]                             undefined
Command failed
...
(node:2175) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 uncaughtException listeners added to [process]. Use emitter.setMaxListeners() to increase limit
...
2022-05-03T10:10:24.030Z info [c-api:contracts-spi/bootstrap.js]                  No metadata file supplied in contract, introspection will generate all the data  
...
<Buffer 44 65 66 61 75 6c 74 20 69 6e 69 74 69 61 74 6f 72 20 73 75 63 63 65 73 73 66 75 6c 2e>
    ...
    #invokeFunctionality
2022-05-03T10:10:24.257Z error [c-api:contracts-spi/chaincodefromcontract.js]     a logging prefix Error: Contract name is not known: name  
Expected Error Error: Contract name is not known: name
...
2022-05-03T10:10:24.372Z error [c-api:contracts-spi/datamarshall.js]              undefined Expected 1 parameters, but 0 have been supplied  
...
2022-05-03T10:10:24.405Z error [c-api:lib/handler.js]                             Failed to find a message for transaction context id theChannelIDaTX  
    ...
    ChaincodeMessageHandler
      chat
        ...
        stream.on.data
2022-05-03T10:10:24.487Z error [c-api:lib/handler.js]                             Chaincode is in "created" state, can only process messages of type "registered", but received "NOT REGISTERED"  
          ✓ should throw error when in state created and MSG_TYPE not REGISTERED
2022-05-03T10:10:24.505Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2022-05-03T10:10:24.505Z error [c-api:lib/handler.js]                             Chaincode is in "ready" state, can only process messages of type "established", but received "NOT REGISTERED"  
          ✓ should throw error when in state established and MSG_TYPE not READY
2022-05-03T10:10:24.525Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2022-05-03T10:10:24.525Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
          ✓ should do nothing when in state ready and MSG_TYPE equals REGISTERED
2022-05-03T10:10:24.550Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2022-05-03T10:10:24.550Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
          ✓ should do nothing when in state ready and MSG_TYPE equals READY
2022-05-03T10:10:24.574Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2022-05-03T10:10:24.574Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
          ✓ should call handleMsgResponse when in state ready and MSG_TYPE equals RESPONSE
2022-05-03T10:10:24.601Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2022-05-03T10:10:24.601Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
          ✓ should call handleMsgResponse when in state ready and MSG_TYPE equals ERROR
2022-05-03T10:10:24.683Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2022-05-03T10:10:24.683Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
          ✓ should call handleInit when in state ready and MSG_TYPE equals INIT
2022-05-03T10:10:24.702Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2022-05-03T10:10:24.702Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
          ✓ should call handleTransaction when in state ready and MSG_TYPE equals TRANSACTION
2022-05-03T10:10:24.732Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2022-05-03T10:10:24.733Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
2022-05-03T10:10:24.733Z error [c-api:lib/handler.js]                             Received unknown message from the peer. Exiting.  
          ✓ should end the process with value 1
        stream.on.end
          ✓ should cancel the stream
        stream.on.error
2022-05-03T10:10:24.801Z error [c-api:lib/handler.js]                             Chat stream with peer - on error: %j {} 
          ✓ should end the stream
2022-05-03T10:10:24.837Z error [c-api:lib/handler.js]                             Chat stream with peer - on error: %j "Error\n    at Context.<anonymous> (/home/vsts/work/1/s/libraries/fabric-shim/test/unit/handler.js:829:35)\n    at callFn (/home/vsts/work/1/s/common/temp/node_modules/.pnpm/mocha@9.1.2/node_modules/mocha/lib/runnable.js:366:21)\n    at Test.Runnable.run (/home/vsts/work/1/s/common/temp/node_modules/.pnpm/mocha@9.1.2/node_modules/mocha/lib/runnable.js:354:5)\n    at Runner.runTest (/home/vsts/work/1/s/common/temp/node_modules/.pnpm/mocha@9.1.2/node_modules/mocha/lib/runner.js:681:10)\n    at /home/vsts/work/1/s/common/temp/node_modules/.pnpm/mocha@9.1.2/node_modules/mocha/lib/runner.js:804:12\n    at next (/home/vsts/work/1/s/common/temp/node_modules/.pnpm/mocha@9.1.2/node_modules/mocha/lib/runner.js:596:14)\n    at /home/vsts/work/1/s/common/temp/node_modules/.pnpm/mocha@9.1.2/node_modules/mocha/lib/runner.js:606:7\n    at next (/home/vsts/work/1/s/common/temp/node_modules/.pnpm/mocha@9.1.2/node_modules/mocha/lib/runner.js:489:14)\n    at Immediate._onImmediate (/home/vsts/work/1/s/common/temp/node_modules/.pnpm/mocha@9.1.2/node_modules/mocha/lib/runner.js:574:5)\n    at processImmediate (internal/timers.js:461:21)" 
    ...
    handleMessage
      Error
2022-05-03T10:10:25.408Z error [c-api:lib/handler.js]                             %s Incorrect payload format. Sending ERROR message back to peer "[theChannelID-aTX]" 
        ✓ should handle an error decoding the payload
2022-05-03T10:10:25.410Z error [c-api:lib/handler.js]                             Failed to construct a chaincode stub instance from the INIT message: an error
    ...
    at stub (/home/vsts/work/1/s/common/temp/node_modules/.pnpm/sinon@11.1.2/node_modules/sinon/lib/sinon/proxy.js:265:26)
    ...
    at /home/vsts/work/1/s/common/temp/node_modules/.pnpm/mocha@9.1.2/node_modules/mocha/lib/runner.js:606:7
    at next (/home/vsts/work/1/s/common/temp/node_modules/.pnpm/mocha@9.1.2/node_modules/mocha/lib/runner.js:489:14)
    at cbHookRun (/home/vsts/work/1/s/common/temp/node_modules/.pnpm/mocha@9.1.2/node_modules/mocha/lib/runner.js:554:7)
    at done (/home/vsts/work/1/s/common/temp/node_modules/.pnpm/mocha@9.1.2/node_modules/mocha/lib/runnable.js:310:5)
    at callFn (/home/vsts/work/1/s/common/temp/node_modules/.pnpm/mocha@9.1.2/node_modules/mocha/lib/runnable.js:389:7)
    at Hook.Runnable.run (/home/vsts/work/1/s/common/temp/node_modules/.pnpm/mocha@9.1.2/node_modules/mocha/lib/runnable.js:354:5)
    at next (/home/vsts/work/1/s/common/temp/node_modules/.pnpm/mocha@9.1.2/node_modules/mocha/lib/runner.js:513:10)
    at Immediate._onImmediate (/home/vsts/work/1/s/common/temp/node_modules/.pnpm/mocha@9.1.2/node_modules/mocha/lib/runner.js:574:5)
    at processImmediate (internal/timers.js:461:21)  
        ✓ should handle error creating a chaincode stub
2022-05-03T10:10:25.413Z error [c-api:lib/handler.js]                             [theChannelID-aTX] Calling chaincode Init() has not called success or error.  
2022-05-03T10:10:25.413Z error [c-api:lib/handler.js]                             [theChannelID-aTX] Calling chaincode Init() returned error response [[theChannelID-aTX] Calling chaincode Init() has not called success or error.]. Sending ERROR message back to peer  
        ✓ should handle chaincode.Init returning nothing
2022-05-03T10:10:25.415Z error [c-api:lib/handler.js]                             [theChannelID-aTX] Calling chaincode Invoke() has not called success or error.  
2022-05-03T10:10:25.415Z error [c-api:lib/handler.js]                             [theChannelID-aTX] Calling chaincode Invoke() returned error response [[theChannelID-aTX] Calling chaincode Invoke() has not called success or error.]. Sending ERROR message back to peer  
        ✓ should handle chaincode.Invoke returning nothing
2022-05-03T10:10:25.419Z error [c-api:lib/handler.js]                             [theChannelID-aTX] Calling chaincode Init() has not called success or error.  
2022-05-03T10:10:25.419Z error [c-api:lib/handler.js]                             [theChannelID-aTX] Calling chaincode Init() returned error response [[theChannelID-aTX] Calling chaincode Init() has not called success or error.]. Sending ERROR message back to peer  
        ✓ should handle chaincode.Init returning no status
2022-05-03T10:10:25.421Z error [c-api:lib/handler.js]                             [theChannelID-aTX] Calling chaincode Invoke() has not called success or error.  
2022-05-03T10:10:25.421Z error [c-api:lib/handler.js]                             [theChannelID-aTX] Calling chaincode Invoke() returned error response [[theChannelID-aTX] Calling chaincode Invoke() has not called success or error.]. Sending ERROR message back to peer  
        ✓ should handle chaincode.Invoke returning no status
      Complete
2022-05-03T10:10:25.423Z info [c-api:lib/handler.js]                              [theChannelID-aTX] Calling chaincode Init() succeeded. Sending COMPLETED message back to peer  
        ✓ should write a COMPLETE message when successful init
2022-05-03T10:10:25.425Z info [c-api:lib/handler.js]                              [theChannelID-aTX] Calling chaincode Invoke() succeeded. Sending COMPLETED message back to peer  
...
2022-05-03T10:10:25.511Z error [c-api:lib/iterators.js]                           unexpected error received getting next value: %s "some error" 
  ...
  Logger
    ✓ coverage
2022-05-03T10:10:25.536Z error [c-api:_]                                          Unhandled Rejection reason __PERMITTED__ promise Promise { <rejected> '__PERMITTED__' }  
2022-05-03T10:10:25.537Z error [c-api:_]                                          Unhandled Rejection reason __PERMITTED__ promise Promise { <rejected> '__PERMITTED__' }  
    getLogger
...
2022-05-03T10:10:25.569Z error [c-api:lib/server.js]                              ChaincodeServer failed to bind to 0.0.0.0:9999  
      ✓ should throw if bindAsync fails
    connect()
      ✓ should call connect
2022-05-03T10:10:25.581Z warn [c-api:lib/server.js]                               connection from peer failed: Error: Some error from chat  
